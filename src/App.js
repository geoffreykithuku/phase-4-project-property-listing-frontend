  ...
  return (
    <div>
      ...
      <Routes>
        ...
        <Route path="/signup" element={<Signup setAccount={setAccount} />} />
        <Route
          path="/"
          element={<Main account={account} setAccount={setAccount} />}
        />
        <Route
          path="/properties/:propertyTypeParam/:locationSearch"
          element={<Properties account={account} setAccount={setAccount} />}
        />
        <Route
          path="/properties/:propertyTypeParam"
          element={<Properties account={account} setAccount={setAccount} />}
        />
        <Route
          path="/properties"
        ...
        <Route path="/mypropertiesform" element={<MyPropertiesForm />} />
      </Routes>
    </div>
  );
}
