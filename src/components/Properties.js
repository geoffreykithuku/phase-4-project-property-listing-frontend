...
function Properties() {
  ...
  function sortedHomes() {
    switch (sortCondition) {
      case "1":
        return [...propertyResults].sort((a, b) =>
          parseInt(a.price.replaceAll("$", "").replaceAll(",", "")) <
          parseInt(b.price.replaceAll("$", "").replaceAll(",", ""))
            ? 1
            : -1
        );
            ...
            <div className="col-md-8">
              <div className="aa-properties-content">
                <div className="aa-properties-content-head">
                  <div className="aa-properties-content-head-left">
                    ...
                    <form action="" className="aa-show-form">
                      ...
                      <select
                        name=""
                        onChange={(e) =>
                          setNumOfHomesPerPage(parseInt(e.target.value))
                        }
                      >
                  ...
                  <div className="aa-properties-content-head-right"></div>
                </div>

                <div className="aa-properties-content-body">
                  <ul className="aa-properties-nav">
                    {paginateHomes(sortedHomes())[pageToShow].map(
                      (propertyResult) => (
                        <li>
                          <article className="aa-properties-item">
                            <a className="aa-properties-item-img" href="#">
                              <Link
                                to={`/propertyDetails/${propertyResult.id}`}
                              >
                                <img alt="img" src={propertyResult.photo} />
                              </Link>
                            </a>
                ...
                <div className="aa-properties-content-bottom">
                  <nav>
                    <ul className="pagination">
                      ...
                      {Array.from(
                        Array(
                          Math.ceil(propertyResults.length / numOfHomesPerPage)
                        ),
                        (_, i) => i
                      ).map((i) => (
                        <li className={i === pageToShow ? "active" : ""}>
                          <a onClick={() => setPageToShow(i)}>{i + 1}</a>
                        </li>
                      ))}
                        ...
                        <a
                          onClick={() =>
                            setPageToShow((p) =>
                              p <
                              Math.ceil(
                                propertyResults.length / numOfHomesPerPage
                              ) -
                                1
                                ? p + 1
                                : p
            ...
            <div className="col-md-4">
              <aside className="aa-properties-sidebar">
                <div className="aa-properties-single-sidebar">
                  <h3>
                    Search {["All", "for Sale", "for Rent"][propertyType]}
                  </h3>
                  <form action="">
                    <div className="aa-single-advance-search">
                      <input
                        type="text"
                        placeholder="Type Your City/Zipcode"
                        value={location}
                        onChange={(e) => {
